...
import com.jd.meeop.lang.Editor;
...
public class CollectionUtil {
	 ...
	 * @return
	 */
	public static <V, T> Map<V, T> countMap(Collection<T> c, String f) {
		HashMap<V, T> m = new HashMap<V, T>();
		for (T t : c) {
			m.put((V) BeanUtil.getFieldValueByName(t ,f), t);
		}
		return m;
	}
	...
	public static Object[] wrap(Object obj) {
		if (isArray(obj)) {
			try {
				...
				if (StringUtil.equals("long", className))
						return wrap((long[]) obj);
				if (StringUtil.equals("int", className))
						return wrap((int[]) obj);
				if (StringUtil.equals("short", className))
						return wrap((short[]) obj);
				if (StringUtil.equals("char", className))
						return wrap((char[]) obj);
				if (StringUtil.equals("byte", className))
						return wrap((byte[]) obj);
				if (StringUtil.equals("boolean", className))
						return wrap((boolean[]) obj);
				if (StringUtil.equals("float", className))
						return wrap((float[]) obj);
				if (StringUtil.equals("double", className))
	 ...
	 * @return
	 */
	public static <T> T lastEle(List<T> l){
